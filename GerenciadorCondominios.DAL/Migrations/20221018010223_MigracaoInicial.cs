        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Apartamento_AspNetUsers_MoradorId",
                        column: x => x.MoradorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Apartamento_AspNetUsers_ProprietarioId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Servico_AspNetUsers_UsuarioId",
                        column: x => x.UsuarioId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Veiculo_AspNetUsers_UsuarioId",
                        column: x => x.UsuarioId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_HistoricoRecursos_Mes_MesId",
                        column: x => x.MesId,
                        principalTable: "Mes",
                        principalColumn: "MesId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ServicoPredio_Servico_ServicoId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Pagamento_Aluguel_AluguelId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "ab70b1fa-7683-4204-9a32-c7c1e51bbc1b", "78f50555-31a0-4fb9-aff9-3f6a0880eb70", "Administrador do Prédio", "Administrador", "ADMINISTRADOR" },
                    { "cb82646b-9e66-4f96-9679-f8fc67fa6cc3", "b006b7d0-d8dc-4ef2-b0c1-402eda62fb82", "Sindico do Prédio", "Sindico", "SINDICO" },
                    { "d1b66635-ffa2-4dc9-9604-47cd020e6267", "7f5bea72-f251-4db9-9b15-cf63c6cec406", "Morador do Prédio", "Morador", "MORADOR" }
                });
